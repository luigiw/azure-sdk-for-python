...
class IndexesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.ai.ml.aio.MachineLearningServicesClient`'s
    ...
    async def get(self, name: str, version: str, **kwargs: Any) -> _models.Index:
        ...
        :rtype: ~azure.ai.ml.models.Index
    ...
    async def create_or_update(
        ...
        :type body: ~azure.ai.ml.models.Index
    ...
    async def create_or_update(
        ...
        :param body: Properties of an Index Version. Is one of the following types: Index, JSON,
         IO[bytes] Required.
        :type body: ~azure.ai.ml.models.Index or JSON or IO[bytes]
        :return: Index. The Index is compatible with MutableMapping
        :rtype: ~azure.ai.ml.models.Index
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.ai.ml.models.Index]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def get_next_version(self, name: str, **kwargs: Any) -> _models.VersionInfo:
        ...
        :rtype: ~azure.ai.ml.models.VersionInfo
        :raises ~azure.core.exceptions.HttpResponseError:
